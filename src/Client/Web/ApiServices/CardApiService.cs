...
namespace Web.ApiServices
{
    public class CardApiService : ICardApiService
    {
        ...
        public CardApiService(IHttpClientFactory httpClientFactory, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<IEnumerable<Card>> GetCards()
        {
            ...
            var httpClient = _httpClientFactory.CreateClient("CardAPIClient");
            ...
            var cardList = JsonConvert.DeserializeObject<List<Card>>(content);
            return cardList;
            ...
            //var response = await client.GetAsync("https://localhost:5001/api/cards");
            //response.EnsureSuccessStatusCode();
